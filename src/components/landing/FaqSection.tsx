...
const faqs = [
  ...
  {
    q: "А если программа не подойдёт?",
    a: "После первой недели работы вы можете отказаться без объяснений и получить полный возврат. Мы заинтересованы работать только там, где есть реальный отклик.",
  },
  {
